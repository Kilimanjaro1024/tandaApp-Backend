...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { hourly_rate: @organisation.hourly_rate, name: @organisation.name } }, as: :json
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { hourly_rate: @organisation.hourly_rate, name: @organisation.name } }, as: :json
    assert_response 200
  end
